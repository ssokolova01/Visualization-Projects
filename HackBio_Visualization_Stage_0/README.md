...
The opening stage of the HackBio Data Visualization in Bio (vizbio) Internship, covering two deliverables: a short technical article written for a wide audience and a first R script introducing data structures and string handling.
-------------------------------------------------------------------------------------------------------------------
